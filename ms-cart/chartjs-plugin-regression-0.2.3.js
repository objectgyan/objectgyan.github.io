...
var MetaDataSet = /** @class */ (function () {
    ...
    MetaDataSet.prototype.drawRegressions = function () {
        console.log('Drawing Regressions');
    ...
    MetaDataSet.prototype.drawRightBorders = function () {
        console.log('Drawing Right Borders');
        var ctx = this.chart.chart.ctx;
        ctx.save();
        try {
...
//https://cdn.jsdelivr.net/gh/rossmann-engineering/chartjs-plugin-regression@master/dist/chartjs-plugin-regression-0.2.3.js
Object.defineProperty(exports, "__esModule", ({ value: true }));
...
var MetaSection = /** @class */ (function () {
    ...
    MetaSection.prototype.drawRange = function (ctx, startIndex, endIndex, forceDash) {
        ...
        try {
            ...
            if (forceDash)
                ctx.setLineDash([5, 5]);
            var predict_1 = this.result.predict;
            var f = function (x, ts) { return _this._meta.getXY(ts, predict_1(x)[1]); };
            //console.log('Start index: ' + startIndex);
            //console.log('End index: ' + endIndex);
            var dataSet_data = void 0;
            dataSet_data = this.dataSets.data;
            if (dataSet_data.length > 0) {
                var timeSpan = void 0;
                timeSpan = dataSet_data[dataSet_data.length - 1].t - dataSet_data[0].t;
                var arraySpan = dataSet_data[dataSet_data.length - 1].x - dataSet_data[0].x;
                var p = f(startIndex, startIndex + dataSet_data[startIndex].t);
                ctx.moveTo(p.x, p.y);
...
/******/ })()
;
//# sourceMappingURL=chartjs-plugin-regression-0.2.3.js.map
